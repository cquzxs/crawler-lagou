...
import com.ssh.service.api.IBaseSalaryRangeViewService;
...
public class DataToView5 implements Runnable{
    ...
    public DataToView5(IRecruitmentInfoSevice recruitmentInfoService, IBaseSalaryRangeViewService baseSalaryRangeViewService) {
     ...
     * 视图5：基于薪资范围的视图
     */
    public void dataToBaseSalaryRangeView(){
